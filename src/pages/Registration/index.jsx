    ...
    <div style={{paddingBottom:"159px"}}>
      <Paper classes={{ root: styles.root }}>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <TextField className={styles.field} label="Username" fullWidth {...register("username", {required:"Enter your username"},{minLength:3,maxLength:32})} />
          <TextField className={styles.field} label="E-Mail" type="email" error={Boolean(isVerif)} helperText={isVerif ? "Enter another email": undefined} {...register("email", {required:"Enter your email"})} fullWidth />
          ...
          <div className={styles.error}>{isVerif?"Sorry, this mail or username are already taken":undefined}</div>
        </form>
      </Paper>
    </div>
  );
